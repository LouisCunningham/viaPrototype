...
const Faq = () => {
  return (
    <>
      <section className="min-h-screen h-100 w-full relative isolate">
        
        <div className="video-background min-h-screen">
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            Everything you need to deploy your app
              ...
              <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 sm:grid-cols-2 lg:grid-cols-3 mb-20">
